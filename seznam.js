...
// Vymazání vnitřního HTML prvku
seznamFilmu.innerHTML = '';

filmy.forEach(film => {
    // Vytvoření nového prvku div pro jednu kartu s filmem
    const filmKarta = document.createElement('div');
    filmKarta.classList.add('col');

    // HTML obsah karty s filmem
    filmKarta.innerHTML = `
        <div class="card">
    ...
    // Přidání karty s filmem do seznamu filmů
